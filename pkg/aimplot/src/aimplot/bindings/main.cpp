...
void init_main(py::module &_aimplot, Registry &registry) {
    ...
    */
    ...
    _aimplot.def("destroy_context", [](py::capsule& ctx)
    {
    ...
    _aimplot.def("get_current_context", []()
    {
    ...
    _aimplot.def("set_current_context", [](py::capsule& ctx)
    {
    ...
    _aimplot.def("plot_line", [](const char* label_id, const py::array_t<double>& values, int count)
    {
    ...
    _aimplot.def("plot_line", [](const char* label_id, const py::array_t<double>& xs, const py::array_t<double>& ys, int count)
    {
    ...
    _aimplot.def("plot_scatter", [](const char* label_id, const py::array_t<double>& values, int count)
    {
    ...
    _aimplot.def("plot_shaded", [](const char* label_id, const py::array_t<double>& values, int count)
    {
    ...
    _aimplot.def("plot_bars", [](const char* label_id, const py::array_t<double>& values, int count)
    {
    ...
    _aimplot.def("plot_bars_h", [](const char* label_id, const py::array_t<double>& values, int count)
    {
    ...
    _aimplot.def("plot_error_bars", [](const char* label_id, const py::array_t<double>& xs, const py::array_t<double>& ys, const py::array_t<double>& err int count)
    {
